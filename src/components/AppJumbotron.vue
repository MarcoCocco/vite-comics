...
<template>
  ...
  <div class="cards-container container-centered">
    <AppCard v-for="card in cardList" :thumb="card.thumb" :series="card.series" :type="card.type" :price="card.price"></AppCard>
  </div>
  <div id="load-button">
